...
from assets.md_templates import orca_template, crest_template, censo_template, xtb_template, gaussian_template, enan_template, molcas_template
...
def molcas_parser(input_file, cmd_line):
